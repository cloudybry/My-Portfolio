...
<header className="hero">
  <div className="hero-content">
    <div className="hero-image">
      <img src="src\pictures\me.png" alt="Bryan Portrait" class="passport-photo" />
    </div>
    ...
    <img src= "src\pictures\Terraform.png " alt="Terraform-localstock showcase" className="project-image" />
    <h3>Terraform-localstock showcase</h3>
    <a href="https://github.com/cloudybry/Terraform-localstack-showcase">View on GitHub</a>
  </div>

  <div className="project-card">
    <img src=" src\pictures\JobTrack.png" alt="Job Track" className="project-image" />
    <h3>Job Track</h3>
    <a href="https://github.com/cloudybry/JobTrack">View on GitHub</a>
  </div>

  <div className="project-card">
    <img src=" src\pictures\MetricPulse.png" alt="Metric Pulse" className="project-image" />
    <h3>Metric Pulse</h3>
    <a href="https://github.com/cloudybry/Metricpulse">View on GitHub</a>
  </div>

  <div className="project-card">
    <img src="src\pictures\BookBase.png" alt="Book Base" className="project-image" />
    <h3>Book Base</h3>
    <a href="https://github.com/cloudybry/BookBase">View on GitHub</a>
  </div>

  <div className="project-card">
    <img src="src\pictures\MindMesh.png" alt="Mind Mesh" className="project-image" />
    <h3>Mind Mesh</h3>
